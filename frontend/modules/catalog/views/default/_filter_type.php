  ...
  <div class="swiper catalog-cat mb-m">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide">
        ...
        if (in_array('category_id', $queryParams) && $queryParams['category_id'][0] == $category->id):
        ?>
          <a class="catalog-cat__el catalog-cat__el--active" href="<?= Yii::$app->request->getPathInfo() . '?category_id[]=' . $category->id; ?>">
        <?php else: ?>
          <a class="catalog-cat__el catalog-cat__el" href="<?= Yii::$app->request->getPathInfo() . '?category_id[]=' . $category->id; ?>">
        <?php endif; ?>
