...
async function cart() {
    ...
    const productOldPrice = document.querySelector('#constructor_price_old').textContent.replace(/\D/g,'');
    ...
    if(document.querySelector('#dogCageSizeParams')) {
        ...
        const width = document.querySelector('#constructor_width').textContent;
        const depth = document.querySelector('#constructor_depth').textContent;
...
// fetch('http://pet-house.local/cart/default/add-to-cart?product_id=24&color=88&walls=77&height=160&width=70&depth=40&price=10000&old_price=12000')
