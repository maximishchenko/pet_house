      ...
      <ul class="list-reset">
        ...
        <?php foreach ($categories as $category) : ?>
          <li class="thumb-filter__li">
            <input class="hide-inp thumb-filter__checkbox filter__submit" type="checkbox" id="<?= $category->id; ?>" name="category_id[]" value="<?= $category->id; ?>" <?= $searchModel->isCheckboxSearchParamSelected('category_id', $category->id); ?>>
            <label for="<?= $category->id; ?>" class="thumb-filter__checkbox-label">
              <span>
                <?= $category->name; ?>
              </span>
            </label>
...
<!-- catalog-bar__btn--disable -->
      ...
      <fieldset class="thumb-filter__area">
        ...
        <ul class="list-reset">
          ...
          <?php foreach ($types as $type) : ?>
            <li class="thumb-filter__li">
              <input class="thumb-filter__checkbox hide-inp filter__submit" type="checkbox" id="<?= $type->id; ?>" name="type_id[]" value="<?= $type->id; ?>" <?= $searchModel->isCheckboxSearchParamSelected('type_id', $type->id); ?>>
              <label for="<?= $type->id; ?>" class="thumb-filter__checkbox-label">
                <span >
                  <?= $type->name; ?>
                </span>
              </label>
  ...
  <input type="text" class="sort-inp visually-hidden" name="order" value="view_count">
