...
<h5>1. Общие положения</h5>
        ...
        <p>
            ...
            Оператору письмо на адрес электронной почты buzyurov@gmail.com с пометкой
        ...
        <p>
            ...
            адрес электронной почты Оператора <?= Html::mailto($settings->getItemValue('contactEmail'), $settings->getItemValue('contactEmail')); ?> с пометкой «Актуализация
        ...
        <p>
            ...
            адрес Оператора <?= Html::mailto($settings->getItemValue('contactEmail'), $settings->getItemValue('contactEmail')); ?> с пометкой «Отзыв согласия на обработку
            персональных данных».
        </p>
        ...
        <p>
            ...
            помощью электронной почты <?= Html::mailto($settings->getItemValue('contactEmail'), $settings->getItemValue('contactEmail')); ?>.</p>
        <p>
        ...
        <p>
            ...
            по адресу <?= Html::a(Url::toRoute('/privacy', true), Url::toRoute('/privacy', true), ['target' => '_blank']); ?>.</p>.</p>
