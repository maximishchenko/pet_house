...
/* harmony import */ var _components_fancy__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/fancy */ "./src/js/components/fancy.js");
...
/* harmony import */ var _components_masonry__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/masonry */ "./src/js/components/masonry.js");
/* harmony import */ var _components_masonry__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_masonry__WEBPACK_IMPORTED_MODULE_5__);
...
const tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('calc-tab');
const orderTabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('order-tab');
...
/* harmony import */ var _vendor_dynamicAdapt__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/dynamicAdapt */ "./src/js/vendor/dynamicAdapt.js");
/* harmony import */ var _vendor_dynamicAdapt__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_dynamicAdapt__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _vendor_sticky_sidebar_min__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/sticky-sidebar.min */ "./src/js/vendor/sticky-sidebar.min.js");
/* harmony import */ var _vendor_sticky_sidebar_min__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_vendor_sticky_sidebar_min__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _vendor_gridMasonry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/gridMasonry */ "./src/js/vendor/gridMasonry.js");
/* harmony import */ var _vendor_gridMasonry__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_vendor_gridMasonry__WEBPACK_IMPORTED_MODULE_3__);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var float_sidebar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! float-sidebar */ "./node_modules/float-sidebar/dist/float-sidebar.js");
/* harmony import */ var float_sidebar__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(float_sidebar__WEBPACK_IMPORTED_MODULE_0__);

const sidebar = document.querySelector('.sidebar');
const relative = document.querySelector('.product__col');
if (sidebar !== null) {
  const floatSidebar = float_sidebar__WEBPACK_IMPORTED_MODULE_0___default()({
    sidebar,
    relative,
    topSpacing: 20,
    bottomSpacing: 20
...
document.querySelectorAll('.calc-el__btn-control').forEach(el => el.addEventListener('click', function (e) {
...
// Вопросы и ответы
document.querySelectorAll('.q-btn').forEach(el => el.addEventListener('click', function (e) {
...
const addAccessories = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.add-accessories__swiper', {
  slidesPerView: 'auto',
  loop: 'true',
  freeMode: true,
  navigation: {
...
// слайдер хиты
const thumbsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.prod-slider', {
  slidesPerView: 1.1,
  freeMode: true,
...
const popCategories = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.pop-categories__slider', {
  slidesPerView: "auto",
  loop: true,
  centeredSlides: true
  /*   navigation: {
...
/******/(function (modules) {
  ...
  /******/
  __nested_webpack_require_182__.p = "/dist/";
  /******/
  /******/ // Load entry module and return exports
  /******/
  return __nested_webpack_require_182__(__nested_webpack_require_182__.s = 0);
  /******/
}
/************************************************************************/
/******/)([/* 0 */
/***/function (module, __webpack_exports__, __nested_webpack_require_2677__) {
  "use strict";
  ...
  __nested_webpack_require_2677__.d(__webpack_exports__, "default", function () {
    return GridMasonry;
  });
...
/***/ "./src/js/vendor/sticky-sidebar.min.js":
/*!*********************************************!*\
  !*** ./src/js/vendor/sticky-sidebar.min.js ***!
  \*********************************************/
/***/ (function(module) {
...
/******/
/******/ 	// The require function
/******/ 	function __nested_webpack_require_782__(moduleId) {
/******/
/******/ 		// Check if module is in cache
/******/ 		if(installedModules[moduleId]) {
/******/ 			return installedModules[moduleId].exports;
...
/******/
/******/ 		// Execute the module function
/******/ 		modules[moduleId].call(module.exports, module, module.exports, __nested_webpack_require_782__);
/******/
/******/ 		// Flag the module as loaded
/******/ 		module.l = true;
/******/
...
/******/
/******/ 	// expose the modules object (__webpack_modules__)
/******/ 	__nested_webpack_require_782__.m = modules;
/******/
/******/ 	// expose the module cache
/******/ 	__nested_webpack_require_782__.c = installedModules;
/******/
/******/ 	// define getter function for harmony exports
/******/ 	__nested_webpack_require_782__.d = function(exports, name, getter) {
/******/ 		if(!__nested_webpack_require_782__.o(exports, name)) {
/******/ 			Object.defineProperty(exports, name, { enumerable: true, get: getter });
/******/ 		}
/******/ 	};
/******/
/******/ 	// define __esModule on exports
/******/ 	__nested_webpack_require_782__.r = function(exports) {
...
/******/ 	__nested_webpack_require_782__.t = function(value, mode) {
/******/ 		if(mode & 1) value = __nested_webpack_require_782__(value);
/******/ 		if(mode & 8) return value;
/******/ 		if((mode & 4) && typeof value === 'object' && value && value.__esModule) return value;
/******/ 		var ns = Object.create(null);
/******/ 		__nested_webpack_require_782__.r(ns);
/******/ 		Object.defineProperty(ns, 'default', { enumerable: true, value: value });
/******/ 		if(mode & 2 && typeof value != 'string') for(var key in value) __nested_webpack_require_782__.d(ns, key, function(key) { return value[key]; }.bind(null, key));
/******/ 		return ns;
/******/ 	};
/******/
/******/ 	// getDefaultExport function for compatibility with non-harmony modules
/******/ 	__nested_webpack_require_782__.n = function(module) {
/******/ 		var getter = module && module.__esModule ?
/******/ 			function getDefault() { return module['default']; } :
/******/ 			function getModuleExports() { return module; };
/******/ 		__nested_webpack_require_782__.d(getter, 'a', getter);
/******/ 		return getter;
/******/ 	};
/******/
/******/ 	// Object.prototype.hasOwnProperty.call
/******/ 	__nested_webpack_require_782__.o = function(object, property) { return Object.prototype.hasOwnProperty.call(object, property); };
/******/
/******/ 	// __webpack_public_path__
/******/ 	__nested_webpack_require_782__.p = "";
/******/
/******/
/******/ 	// Load entry module and return exports
/******/ 	return __nested_webpack_require_782__(__nested_webpack_require_782__.s = 0);
/******/ })
/************************************************************************/
/******/ ([
/* 0 */
/***/ (function(module, __webpack_exports__, __nested_webpack_require_4258__) {

"use strict";
// ESM COMPAT FLAG
__nested_webpack_require_4258__.r(__webpack_exports__);
